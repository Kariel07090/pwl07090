		...
		<div class="utama">
			...
			<span class="float-right">
				...
				<div class="form-group">
					<input class="form-control me-2 mb-2" type="text" name="cari" placeholder="Cari data mahasiswa..." autofocus autocomplete="off" id="keyword ">
				...
				<tbody>
					...
					?>	
						<tr>
							...
							<td><img src="<?php echo "foto/mhs/".$row["foto"]?>" height="50"></td>
							<td>
